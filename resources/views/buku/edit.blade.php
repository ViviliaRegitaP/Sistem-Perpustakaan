                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('bukus.update', $buku) }}" method="POST" novalidate id="bukuFormEdit">
                        ...
                        <div class="row g-3">
                            ...
                            {{-- YANG DIBENERIN CUMA BAGIAN INI --}}
                            <div class="col-md-6">
                                ...
                                >
                                    ...
                                    @foreach($categories as $category)
                                        ...
                                        <option
                                            ...
                                            {{ old('kategori_id', $buku->kategori_id) == $category->getKey() ? 'selected' : '' }}
                                        >
                            ...
                            <div class="col-md-6 d-flex align-items-end justify-content-md-end">
                                ...
                                <div class="d-grid d-md-flex gap-2">
                                    ...
                                    <a
                                        ...
                                        class="btn"
                                        style="background: rgba(44,52,27,.10); color: var(--text); border:1px solid rgba(44,52,27,.12); font-weight:800;"
                                    >
