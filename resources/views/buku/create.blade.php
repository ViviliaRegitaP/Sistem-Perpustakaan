            ...
            <div class="card border-0" style="background: rgba(255,255,255,.78); backdrop-filter: blur(10px); box-shadow: 0 10px 30px rgba(17,24,39,.06);">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                        ...
                        <div class="small" style="color: var(--muted);"><i class="bi bi-plus-circle me-1"></i> Input data buku</div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="kode_buku" class="form-control @error('kode_buku') is-invalid @enderror" value="{{ old('kode_buku') }}" required id="kode_buku" placeholder="Kode Buku">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="tahun_terbit" class="form-control @error('tahun_terbit') is-invalid @enderror" value="{{ old('tahun_terbit') }}" required min="1800" max="2100">
                                @error('tahun_terbit')
                            ...
                            <div class="col-md-6 d-flex align-items-end justify-content-md-end">
                                <div class="d-grid d-md-flex gap-2">
                                    ...
                                    <button type="submit" class="btn fw-semibold" style="background: var(--secondary,#4F46E5); color:#fff; border:0; font-weight:900;" id="btnSaveCreate">
