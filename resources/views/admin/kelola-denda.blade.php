                    ...
                    @if($pinjam->status === 'terlambat' && $telat > 0)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @php
                                    $status = $pinjam->fine?->status ?? 'UNPAID';
                                    $sudahDibayar = $status === 'PAID';
                                @endphp
                                ...
                                @else
                                    <form
                                        method="POST"
                                        action="{{ route('denda.update', $pinjam->fine?->fines_id) }}"
                                    >
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <button type="submit" class="btn action-btn lunas-btn">
                                            Lunas
                                        </button>
                                    </form>
                                @endif
